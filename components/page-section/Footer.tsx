...
interface NavigationDataInt {
  name: string;
  href: string;
  icon: JSX.Element;
}

const navigation: NavigationDataInt[] = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=100095380622749",
    icon: (
      <svg
        fill="currentColor"
        viewBox="0 0 24 24"
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/sahabad_solution",
    icon: (
      <svg
        fill="currentColor"
        viewBox="0 0 24 24"
  ...
  {
    name: "Whatsapp",
    href: "https://api.whatsapp.com/send?phone=62895386849956",
    icon: (
      <svg
        width="24px"
        height="24px"
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          <p className="text-center text-xs leading-5 text-gray-500">
            &copy; 2024 Sahabad Solution Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
